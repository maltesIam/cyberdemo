...
def generate_supply_chain_scenario() -> SupplyChainScenarioData:
    ...
    # Supply chain techniques: T1195.002, T1071.001, T1055.001, T1059.001
    timeline_events = [
        {
        ...
        },
        {
            ...
            "event": "process_injection_detected",
            "details": "Malicious code injected into browser process",
            "mitre_tactic": "TA0004",
            "tactic_id": "TA0004",
        ...
        },
        {
            ...
            "event": "credential_access_attempt",
            "details": "Attempted credential theft from browser storage",
            "mitre_tactic": "TA0006",
            "tactic_id": "TA0006",
